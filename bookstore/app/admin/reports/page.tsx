...
import { statsApi, Summary, MonthlyRevenue, DailyOrders, TopBook, CategoryStat, LowStockBook, OrderStatusStat } from '@/lib/api/stats-api';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { Loader2, DollarSign, ShoppingCart, TrendingUp, BarChart3, BookOpen, Users } from 'lucide-react';
import {
...
function MetricCard({
  ...
  icon: any; iconBg: string; iconColor: string; trend?: string;
}) {
  return (
    <Card>
...
export default function AdminReportsPage() {
  ...
  // Category data cho pie chart (dùng bookCount thay value)
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Phân tích doanh thu và hoạt động kinh doanh</p>
      </div>
      ...
      {summary && (
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            <MetricCard label="Giá trị đơn TB" value={fmt(summary.avgOrderValue)}
              sub="/đơn hàng" icon={BarChart3} iconBg="bg-purple-100" iconColor="text-purple-600" />
          </div>
          <div className="lg:col-span-2">
            <MetricCard label="Tỷ lệ hoàn thành" value={`${summary.completionRate}%`}
              sub="đơn hàng" icon={TrendingUp} iconBg="bg-amber-100" iconColor="text-amber-600" />
          </div>
          <div className="lg:col-span-2">
          ...
          <div className="lg:col-span-2">
            <MetricCard label="Tổng người dùng" value={String(summary.totalUsers)}
